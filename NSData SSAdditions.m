...
@implementation NSData (SSMessageBase64Additions)
...
- (NSString *)encodeBase64WithNewlines:(BOOL)encodeWithNewlines {
	...
	char *outputBuffer = __NewBase64Encode(self.bytes, self.length, encodeWithNewlines, &outputLength);
